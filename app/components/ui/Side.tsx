...
export default function Sidebar({ activeItem, onMenuClick, isOpen }: SidebarProps) {
                ...
                {menuItems.map((item) => (
                    <div key={item.id}>
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-3 transition-colors border-b border-white/10 ${activeItem === item.id ? 'bg-[#DC143C] text-white' : 'text-white hover:bg-white/10'
                                }`}
                        >
                            {item.icon}
                            ...
                            <div className="bg-black/20">
                                {item.subItems.map((subItem) => (
                                    <button
                                        ...
                                        className="w-full text-left px-12 py-2 text-sm hover:bg-white/10 transition-colors text-white"
                                    >
                                        {subItem.label}
                                    </button>
                                ))}
