                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3 flex-1">
                                {/* Birthday Icon */}
                                <div className="bg-orange-500 bg-opacity-20 rounded-full p-3 flex-shrink-0">
                            ...
                            <button
                                ...
                                className="ml-3 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg text-sm font-semibold transition-all duration-200 shadow-md hover:shadow-lg flex-shrink-0"
                            >
                                Send Wishes
                            </button>
                        </div>
