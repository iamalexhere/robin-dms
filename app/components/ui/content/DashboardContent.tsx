    ...
    return (
        <div className="p-6">
            ...
            <div className="mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="/repair-orders" className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 border border-gray-700 hover:border-orange-500 transition-all group">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-white font-semibold">New Repair Order</h3>
                            <p className="text-gray-400 text-sm">Create RO</p>
                        </div>
                    </div>
                </a>

                <a href="/customer" className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 border border-gray-700 hover:border-orange-500 transition-all group">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm">Register Client</p>
                        </div>
                    </div>
                </a>

                <a href="/mrn" className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 border border-gray-700 hover:border-orange-500 transition-all group">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-white font-semibold">Stock Check</h3>
                            <p className="text-gray-400 text-sm">View Inventory</p>
                        </div>
                    </div>
                </a>
